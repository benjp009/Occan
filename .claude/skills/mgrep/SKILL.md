...
```bash
mgrep --store 5f3e4b46-fdbd-4f6c-aafa-7913134244fd "What code parsers are available?"  # search in the current directory
mgrep --store 5f3e4b46-fdbd-4f6c-aafa-7913134244fd "How are chunks defined?" src/models  # search in the src/models directory
mgrep --store 5f3e4b46-fdbd-4f6c-aafa-7913134244fd -m 10 "What is the maximum number of concurrent workers in the code parser?"  # limit the number of results to 10
mgrep --store 5f3e4b46-fdbd-4f6c-aafa-7913134244fd --web --answer "How can I integrate the javascript runtime into deno"  # include a summary of the web search results
```
