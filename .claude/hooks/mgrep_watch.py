...
if __name__ == "__main__":
    ...
    process = subprocess.Popen(["mgrep", "--store", "5f3e4b46-fdbd-4f6c-aafa-7913134244fd", "watch"], preexec_fn=os.setsid, stdout=open(f"/tmp/mgrep-watch-command-{payload.get('session_id')}.log", "w"), stderr=open(f"/tmp/mgrep-watch-command-{payload.get('session_id')}.log", "w"))
